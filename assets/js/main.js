...
scroll_Animation.reveal(`.about__data, .celebrate__img`, {origin: 'right'})
scroll_Animation.reveal(`.about__img, .celebrate__data`, {origin: 'left'})
scroll_Animation.reveal(`.send__card`, {interval: 100})
scroll_Animation.reveal(`.footer`)